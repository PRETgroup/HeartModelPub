...
if outputs.units == 2 
    ...
    assignin('base','period',0.001);
    assignin('base','timescale','sec');
    assignin('base','buffer',0.599);
...
% TO DEBUG: _pace and _nopace functionality
% 25/07/25: works with Normal parameters.
% Next: test with other parameter sets
%       think about switch heart models with one created using Libs_unified
