...
%%can be skipped.
filexls='Heart_N3_second_374N1479P342VM'; % The excel file name
...
filename= [path_var,filesep,'N3Cfg_second_374N1479P342VM.mat']; 
% contains all parameters of heart model, which will be used for simulation
datafile=[path_var,filesep,'N3Data_second_374N1479P342VM.mat']; 
...
HeartModel='Heart_374N1479P342VM'; % The name of the heart model
