...
%%can be skipped.
filexls='Heart_N3_second_932N4245P900VM'; % The excel file name
...
filename= [path_var,filesep,'N3Cfg_second_932N4245P900VM.mat']; 
% contains all parameters of heart model, which will be used for simulation
datafile=[path_var,filesep,'N3Data_second_932N4245P900VM.mat']; 
...
HeartModel='Heart_932N4245P900VM'; % The name of the heart model
