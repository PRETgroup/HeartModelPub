...
%%can be skipped.
filexls='Heart_N3_second_61'; % The excel file name
...
filename= [path_var,filesep,'N3Cfg_second_61.mat']; 
% contains all parameters of heart model, which will be used for simulation
datafile=[path_var,filesep,'N3Data_second_61.mat']; 
...
HeartModel='Heart_61'; % The name of the heart model
