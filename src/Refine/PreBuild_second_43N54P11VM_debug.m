...
%%can be skipped.
filexls='Heart_N3_second_43N54P11VM'; % The excel file name
...
filename= [path_var,filesep,'N3Cfg_second_43N54P11VM.mat']; 
% contains all parameters of heart model, which will be used for simulation
datafile=[path_var,filesep,'N3Data_second_43N54P11VM.mat']; 
...
HeartModel='Heart_43N54P11VM_debug'; % The name of the heart model
Buildmodel_fcn_debug(HeartModel,filename,node_n,node_m,node_nm,path,probe,path_var,library);
