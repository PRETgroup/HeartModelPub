...
%%can be skipped.
filexls='Heart_N3_second_93N270P61VM'; % The excel file name
...
filename= [path_var,filesep,'N3Cfg_second_93N270P61VM.mat']; 
% contains all parameters of heart model, which will be used for simulation
datafile=[path_var,filesep,'N3Data_second_93N270P61VM.mat']; 
...
HeartModel='Heart_93N270P61VM'; % The name of the heart model
