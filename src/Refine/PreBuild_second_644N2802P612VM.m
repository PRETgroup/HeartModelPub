...
%%can be skipped.
filexls='Heart_N3_second_644N2802P612VM'; % The excel file name
...
filename= [path_var,filesep,'N3Cfg_second_644N2802P612VM.mat']; 
% contains all parameters of heart model, which will be used for simulation
datafile=[path_var,filesep,'N3Data_second_644N2802P612VM.mat']; 
...
HeartModel='Heart_644N2802P612VM'; % The name of the heart model
