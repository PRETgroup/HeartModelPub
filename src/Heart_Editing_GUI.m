function Heart_Editing_GUI(mdl,modelName,filename,savepath,raw_excel,raw_probes,model_params,node_atts,node_atts_copy,path_atts,path_atts_copy)
...
xlabel(ConfigGUI.AP_nodetrace,'Time (ms)');
